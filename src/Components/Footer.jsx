  ...
  return(
    ...
    <footer className=" mb-0" ref={ref}>
      ...
      <ul className="contact">
        <li>
          <a href="https://github.com/SPraveenKumar-spk" target="_blank" title="github"><FaGithub /></a>
        </li>
        <li>
          <a href="https://www.linkedin.com/in/s-praveenkumar/" target="_blank" title="likedin"><FaLinkedin /></a>
        </li>
        <li>
